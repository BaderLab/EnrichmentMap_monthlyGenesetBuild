 ...
 */
public class GeneSetTranslator_UniprotREST {
    ...
    public GeneSetTranslator_UniprotREST() {


    }

    public GeneSetTranslator_UniprotREST(String gmt_filename, int taxonomyId, String oldID, String newID, String conversionFileName)  {
    ...
    public GeneSetTranslator_UniprotREST(String gmt_filename, int taxonomyId, String oldID, String newID, String uniprotFileName, String ncbiFileName)  {
        this.gmt_filename = gmt_filename;
        this.taxonomyId = taxonomyId;
        this.oldID = oldID;
	this.newID = newID;
    ...
    public GeneSetTranslator_UniprotREST(String gmt_filename, int taxonomyId, String oldID, String newID, String uniprotFileName, String ncbiFileName, String conversionFileName)  {
        this.gmt_filename = gmt_filename;
        this.taxonomyId = taxonomyId;
        this.oldID = oldID;
	this.newID = newID;
